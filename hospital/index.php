  ...
  <nav class="navbar navbar-expand-lg navbar-light  stroke">
    ...
    <div class="collapse navbar-collapse" id="navbar">
      ...
      <form class="form-inline">
        <div class="col-auto">
          <label class="sr-only" for="inlineForm" style="color:white">Search</label>
          <div class="input-group mb-2">
            
            <input type="text" class="form-control" id="inlineForm">
...
<div class="container hospital">
      ...
      <div class="col-md-4 body">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <button onclick="myFunction()" id="myBtn" class="btn-primary">Read more</button>
          </div>
        </div>
      </div>
  ...
  <div class="carousel-item">
    <img src="image/donation5.jpg" class="d-block w-100" alt="...">
  </div>
  </div>
</div>
<div class="card-body">
  ...
  <button onclick="myFunction1()" id="myBtn1" class="btn-primary">Read more</button>
</div>
        </div>
      </div>
      ...
      <div class="col-md-4 body">
        ...
        <div class="card">
          <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="image/donation6.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
          ...
          <div class="card-body">
            ...
            <button onclick="myFunction2()" id="myBtn2" class="btn-primary">Read more</button>
          </div>
        </div>
      </div>
    </div>
...
<footer class="page-footer font-small  pt-4 pl-5 mt-4" style="background-color: #300add;">
...
<footer class="page-footer font-small blue">
  ...
  <!-- Copyright -->
  <div class="footer-copyright text-center py-3">Design By:
    <a href="https://mdbootstrap.com/"> Group 4</a>
  </div>
  <!-- Copyright -->
